...
export default function AppSettingsView() {
  ...
  const isClearingCache = useSettingsStore((s) => s.isClearingCache);
  const setClearingCache = useSettingsStore((s) => s.setClearingCache);
  ...
  const syncOptions = ['realtime', 'hourly', 'daily'];
