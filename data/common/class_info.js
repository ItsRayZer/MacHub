...
(function () {
    ...
    window.CLASS_TIMETABLE_BCA = {
        "Monday": [
            ...
            { period: "2", time: "10:30 AM - 11:30 AM", code: "MG2CCRBCA101", title: "Data Structures", room: "Room 101" },
            { period: "3", time: "11:30 AM - 12:30 PM", code: "MG2AECENG100", title: "English II", room: "Room 101" },
            { period: "4", time: "01:30 PM - 02:30 PM", code: "MG2CCRBCA102", title: "Operating Systems", room: "Lab 1" },
            { period: "5", time: "02:30 PM - 03:30 PM", code: "MG2VACBCA100", title: "Indian Constitution", room: "Room 101" }
        ],
        "Tuesday": [
            { period: "1", time: "09:30 AM - 10:30 AM", code: "MG2CCRBCA101", title: "Data Structures", room: "Room 101" },
            { period: "2", time: "10:30 AM - 11:30 AM", code: "MG2CCRBCA102", title: "Operating Systems", room: "Room 101" },
            { period: "3", time: "11:30 AM - 12:30 PM", code: "MG2SECBCA100", title: "Web Technologies", room: "Lab 2" },
            { period: "4", time: "01:30 PM - 02:30 PM", code: "MG2CCRBCA100", title: "Mathematics II", room: "Room 101" },
            { period: "5", time: "02:30 PM - 03:30 PM", code: "MG2CCRBCA102", title: "Operating Systems", room: "Room 101" }
        ],
        "Wednesday": [
            { period: "1", time: "09:30 AM - 10:30 AM", code: "MG2SECBCA100", title: "Web Technologies", room: "Room 101" },
            { period: "2", time: "10:30 AM - 11:30 AM", code: "MG2CCRBCA101", title: "Data Structures", room: "Room 101" },
            { period: "3", time: "11:30 AM - 12:30 PM", code: "MG2CCRBCA100", title: "Mathematics II", room: "Room 101" },
            { period: "4", time: "01:30 PM - 02:30 PM", code: "MG2CCRBCA102", title: "Operating Systems", room: "Room 101" },
            { period: "5", time: "02:30 PM - 03:30 PM", code: "MG2CCRBCA101", title: "Data Structures", room: "Lab 1" }
        ],
        "Thursday": [
            { period: "1", time: "09:30 AM - 10:30 AM", code: "MG2CCRBCA102", title: "Operating Systems", room: "Room 101" },
            { period: "2", time: "10:30 AM - 11:30 AM", code: "MG2CCRBCA100", title: "Mathematics II", room: "Room 101" },
            { period: "3", time: "11:30 AM - 12:30 PM", code: "MG2VACBCA100", title: "Indian Constitution", room: "Room 101" },
            { period: "4", time: "01:30 PM - 02:30 PM", code: "MG2CCRBCA101", title: "Data Structures", room: "Room 101" },
            { period: "5", time: "02:30 PM - 03:30 PM", code: "MG2SECBCA100", title: "Web Technologies", room: "Lab 2" }
        ],
        "Friday": [
            { period: "1", time: "09:30 AM - 10:30 AM", code: "MG2CCRBCA101", title: "Data Structures", room: "Room 101" },
            { period: "2", time: "10:30 AM - 11:30 AM", code: "MG2SECBCA100", title: "Web Technologies", room: "Room 101" },
            { period: "3", time: "11:30 AM - 12:30 PM", code: "MG2CCRBCA102", title: "Operating Systems", room: "Room 101" },
            { period: "4", time: "01:30 PM - 02:30 PM", code: "MG2CCRBCA100", title: "Mathematics II", room: "Room 101" },
            { period: "5", time: "02:30 PM - 03:30 PM", code: "MG2VACBCA100", title: "Indian Constitution", room: "Room 101" }
        ]
    };
    ...
    window.CLASS_SUBJECTS_BCA = [
        {
            ...
            syllabus: [
                "Module 1: Introduction to Data Structures - Arrays, structures, analysis of algorithms.",
                "Module 2: Stacks and Queues - Array representation, operations, infix/postfix conversions.",
                "Module 3: Linked Lists - Single, double, and circular lists, dynamic allocation.",
                "Module 4: Trees & Graphs - Binary trees, traversals, BST operations, DFS/BFS algorithms.",
                "Module 5: Sorting and Searching - Bubble, quick, merge sort, binary search."
            ]
        },
        {
            code: "MG2SECBCA100",
            ...
            syllabus: [
                "Module 1: Web Essentials - Introduction to HTML5 tags, elements, structure.",
                "Module 2: Styling and Layouts - CSS3 styles, flexbox, CSS grid, responsiveness.",
                "Module 3: Clientside Scripting - JavaScript basics, variables, functions, ES6 features.",
                "Module 4: DOM Interaction - Selecting elements, event listeners, form validations.",
                "Module 5: Modern Libraries - Intro to JSON, API requests, and web components."
            ]
        },
        {
            code: "MG2CCRBCA100",
            ...
            syllabus: [
                "Module 1: Linear Algebra - Matrices, determinants, eigenvalues, eigenvectors.",
                "Module 2: Differential Calculus - Partial differentiation, homogeneous functions.",
                "Module 3: Integral Calculus - Double and triple integrals, area, volume.",
                "Module 4: Infinite Series - Convergence, divergence, ratio test, root test.",
                "Module 5: Probability Distributions - Binomial, Poisson, normal distributions."
            ]
        },
        {
            code: "MG2CCRBCA102",
            ...
            syllabus: [
                "Module 1: OS Principles - Services, system calls, OS architecture.",
                "Module 2: Process Scheduling - Scheduling criteria, FCFS, SJF, Round Robin.",
                "Module 3: Memory Management - Paging, segmentation, page replacement.",
                "Module 4: Storage & Files - Directories, allocation methods, disk scheduling.",
                "Module 5: Protection & Security - Access matrix, authentication, system threats."
            ]
        },
        {
            code: "MG2VACBCA100",
            ...
            teacher: {
                ...
                email: "meera.joseph@maraugusthinose.edu.in",
                hours: "Mon, 1:30 PM - 2:30 PM",
                room: "Faculty Common Room"
            },
            syllabus: [
                "Module 1: Constitution Making - Historical background, constituent assembly.",
                "Module 2: Fundamental Rights - Preamble, Right to Equality, Freedom, Religion.",
                "Module 3: Directives and Duties - Directive principles, fundamental duties.",
                "Module 4: Union Executive - President, Prime Minister, Parliament.",
                "Module 5: Judiciary - Supreme Court, High Courts, Judicial Review."
            ]
        }
    ];
